...
# --- Constantes de VEA (ADAPTADAS PARA AGUAS) ---
BUSQUEDAS_VEA = [
    # Aguas Minerales (Búsqueda genérica)
    "https://www.vea.com.ar/api/catalog_system/pub/products/search/agua%20mineral?_from=0&_to=39",
    "https://www.vea.com.ar/api/catalog_system/pub/products/search/agua%20mineral?_from=40&_to=79",

    # Aguas por Marca (Ejemplos comunes)
    "https://www.vea.com.ar/api/catalog_system/pub/products/search/villavicencio?_from=0&_to=19",
    "https://www.vea.com.ar/api/catalog_system/pub/products/search/nestle%20pureza?_from=0&_to=19",
    "https://www.vea.com.ar/api/catalog_system/pub/products/search/glaciar?_from=0&_to=19",
...
def fetch_single_item_data(item, codigo_suc_vtex, codigo_ccx):
    ...
    try:
        ...
        try:
            ...
            # print(f"[Debug Vea] SKU {item_id}: Error al parsear JSON de precio. Error: {e}. Respuesta: {response_precio.text[:100]}...")
            return None
        ...
        if stock > 0:
            ...
            # print(f"[Debug Vea] SKU {item_id}: Stock 0. (Cookie: {codigo_suc_vtex})")
            return None # Producto sin stock
            
    except requests.exceptions.RequestException as e_precio:
        # print(f"[Debug Vea] SKU {item_id}: Falló la llamada de PRECIO. Error: {e_precio}")
