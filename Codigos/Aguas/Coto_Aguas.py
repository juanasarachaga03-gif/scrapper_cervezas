...
# --- CONSTANTES DE COTO (ADAPTADAS PARA AGUAS) ---
# Obtenidas de los nodos 'Skus 0 a N' del JSON de n8n
URL_BASE_COTO = "https://www.cotodigital.com.ar/sitios/cdigi/categoria/"

# IDs de las categorías de AGUAS:
IDS_CATEGORIAS_COTO = [
    # 1. Aguas Minerales (ID: N-17xtqou) <-- NUEVA INCLUSIÓN
    "catalogo-bebidas-bebidas-sin-alcohol-aguas/_/N-17xtqou", 
]
# Parámetros comunes de la URL (Nrpp=153 para cantidad de ítems)
URL_PARAMS = "?format=json&Nrpp=153&idSucursal="
...
def procesar_respuesta_coto_json(json_data, nombre_suc, provincia):
    ...
    # 2. Si no hay productos, intentar el índice [1] (Fallback, probable para categorías pequeñas)
