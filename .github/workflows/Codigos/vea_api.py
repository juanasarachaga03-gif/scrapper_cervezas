...
# --- Constantes de VEA (CORREGIDAS) ---

BUSQUEDAS_VEA = [
    # cerveza principal (muchas páginas)
    *(f"https://www.vea.com.ar/api/catalog_system/pub/products/search/cerveza?_from={i}&_to={i+49}" for i in range(0, 600, 50)),

    # variantes clave (muy importante)
    *(f"https://www.vea.com.ar/api/catalog_system/pub/products/search/beer?_from={i}&_to={i+49}" for i in range(0, 200, 50)),
    *(f"https://www.vea.com.ar/api/catalog_system/pub/products/search/lager?_from={i}&_to={i+49}" for i in range(0, 200, 50)),
    *(f"https://www.vea.com.ar/api/catalog_system/pub/products/search/ipa?_from={i}&_to={i+49}" for i in range(0, 200, 50)),
