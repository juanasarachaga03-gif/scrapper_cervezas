...
# --- CORRECCIÓN: Definir los TÉRMINOS DE BÚSQUEDA (ADAPTADOS PARA AGUAS) ---
IDS_CATEGORIAS_DIA = [
    "agua_mineral",     # <-- NUEVO: Para Aguas Minerales, sin gas, con gas.
]
# -------------------------------------------------
...
def fetch_data_dia(id_tienda_cookie, termino_busqueda, status_box):
    ...
    termino_busqueda: El string de búsqueda (ej: "agua_mineral").
    """
